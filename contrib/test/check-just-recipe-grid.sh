...
expected = [
    ...
    "quality-format-check-fd-linux-x86",
    "quality-format-fix-fd-linux-x86",
    "quality-format-check-tk-linux-x86",
    "quality-format-fix-tk-linux-x86",
    "quality-lint-check-fd-linux-x86",
    "quality-lint-check-tk-linux-x86",
    "quality-proto-check-fd-linux-x86",
    "quality-proto-check-tk-linux-x86",
    "security-codeql-check-fd-linux-x86",
    "security-codeql-check-tk-linux-x86",
    "security-gitleaks-check-fd-linux-x86",
    "security-gitleaks-check-tk-linux-x86",
    "security-seccomp-check-fd-linux-x86",
    "security-seccomp-check-tk-linux-x86",
    "security-proof-check-fd-linux-x86",
    "security-proof-check-tk-linux-x86",
    "security-sanitize-check-fd-linux-x86",
    "security-sanitize-check-tk-linux-x86",
    "security-engine-check-changes-linux-x86",
    "security-engine-check-orchestration-linux-x86",
]
