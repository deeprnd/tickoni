#!/usr/bin/env bash
# linux-x86-ops.sh — Linux x86_64 optional user-level tools (no sudo needed)
set -euo pipefail
...
log_info "Linux x86_64 ops setup starting..."
...
log_info "Linux x86_64 ops setup complete"
