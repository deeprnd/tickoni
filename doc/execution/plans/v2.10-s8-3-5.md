# Story 8.3.5 — Test `just setup-env` and `just tests-all` from all sides
...
test-integration-all → test-integration-fd (placeholder @true) + test-integration-tk
test-cov-all → test-cov-fd (placeholder @true) + test-cov-tk
