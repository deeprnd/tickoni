...
- [ ] Firedancer deps built (libsnappy.a + librocksdb.a present) — BLOCKED: ./opt root-owned, no passwordless sudo
...
- [ ] E2E tests: fd placeholder confirmed, tk folded into demo
...
- [ ] No workspace pollution after full run — needs clean-room verification
