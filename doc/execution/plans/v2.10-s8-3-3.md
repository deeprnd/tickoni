...
- [ ] Clean-room setup-env completed: exit 0, all categories installed
- [ ] Idempotent setup-env: all already_installed
- [ ] Dry-run output matches expected tool list
- [ ] Dependency resolution is topologically correct
- [ ] Platform filtering works for linux, macos, windows
- [ ] OpenSSL built successfully (libssl.a + libcrypto.a present)
- [ ] Firedancer deps built (libsnappy.a + librocksdb.a present)
- [ ] Zig installed and discoverable
- [ ] Security tools installed (cbmc, litani, universal-ctags)
- [ ] Build-all: FD libs + TK binary produced
- [ ] Format check: all source passes
- [ ] Lint check: no violations
- [ ] Proto check: no violations
- [ ] Gitleaks: no false positives
- [ ] Unit tests: tk pass, fd pass
- [ ] Integration tests: tk pass, fd placeholder confirmed
- [ ] Demo conformance: all 4 contracts pass
- [ ] E2E tests: fd pass, tk placeholder confirmed
- [ ] System tests: tk pass (llm-server verified), fd placeholder confirmed
- [ ] Coverage: tk collects, fd placeholder confirmed
- [ ] test-all: all lanes pass
- [ ] tests-all: full handoff gate passes
- [ ] No workspace pollution after full run
