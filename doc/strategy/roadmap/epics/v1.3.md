...
one deterministic, UI-independent portfolio/cash decision demo. The demo should
prove the runtime/interface contract that a future CaseOps UI can render, not
introduce a temporary UI surface. It shows before/after portfolio and cash
states, saves thesis and proposal cards, applies deterministic drift fixtures,
and exposes alerts and rebalance suggestions through one combined payload.
