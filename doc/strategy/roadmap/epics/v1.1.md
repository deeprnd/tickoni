...
Users have investment ideas but don't know if they're sound. V1.0 proved
Tickoni can process financial events. V1.1 gives the user a working investing
copilot that turns those ideas into a concrete basket with affordability checks
and clear explanations — so they can test their own judgment without risking
real money.
...
- receive a basket of candidate instruments with reasons for inclusion
...
- check affordability: estimated cost, cash available, buying power, remaining
  cash, max affordable amount
...
A user types an investment thesis and watches it become a basket, ticket, and
paper trade — with the obvious failures also demonstrated: a request that's too
expensive gets blocked with an exact maximum affordable amount, and restricted
instruments are rejected with clear reasons.
