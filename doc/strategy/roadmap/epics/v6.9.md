...
**Labels:** `epic`, `area/crypto`, `area/investing`, `area/security`

Turn a crypto spot-market view into a guarded paper ticket, then keep exchange
trading authority separate from wallet, network, custody, chain-risk, and
travel-rule controls for transfers.

---

## Product Intent

The user describes a crypto spot intent, gets an explainable trade plan, and
paper-trades or submits an allowed ticket to an approved sandbox venue without
giving an agent unrestricted exchange or wallet authority.
