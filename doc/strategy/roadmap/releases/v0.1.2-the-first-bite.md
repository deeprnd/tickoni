...
## Epic V2.21 — [macOS Retail Runtime Support](https://github.com/deeprnd/tickoni/issues/703)
...
## What Comes Next: [V2.22 — Windows Retail Runtime Support](https://github.com/deeprnd/tickoni/issues/794)

V2.22 carries the V0.1.2 pattern to the Windows environment. Where V0.1.2 establishes the macOS retail runtime path, V2.22 adapts it for Windows consumer hardware. The shared foundations — tier definitions, build scoping, preflight, conformance evidence, trust documentation — established in V0.1.2 form the template. Linux remains the full high-throughput Firedancer tile runtime. macOS and Windows each gain their own supported runtime path for deterministic paper and sandbox workflows.