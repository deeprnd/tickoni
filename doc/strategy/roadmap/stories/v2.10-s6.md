...
- In scope: update all 7 workflow files in `.github/workflows/` to use
...
- The 7 workflow files are: `build-tk.yml`, `build-fd.yml`, `quality.yml`,
...
- [ ] All 7 workflow files use fully-qualified recipe names.
