...
# Explicitly set AVX10 width to 256-bit; otherwise Clang-18 promotes
# +avx10.1-256 to avx10.1-512 which conflicts with -march=icelake-server
# and fails with -Werror,-Winvalid-feature-combination.
CPPFLAGS+=-march=icelake-server -mtune=icelake-server -mfpmath=sse -mavx10.1-256 \
